...
function extract_features(
        ...
        timestep_delta, 
        record_length, #????
        offset, # from ends of the trajectories
        prime,
        maxframes)
...
function extract_ngsim_features(
        ...
        offset = 120, # from ends of the trajectories
        prime = 10,
    ...
    for traj_idx in 1:n_expert_files
        ...
        # setup
        # function defined in /home/silver/.julia/v0.6/NGSIM/src/trajdata.jl
        trajdata = load_trajdata(traj_idx)
        # load trajdata_**** not i101***
...
# NGSIM
extract_ngsim_features(output_filename="ngsim_22agents.h5", n_expert_files=1)

# DEBUG
#trajdata_filepath = "/home/silver/.julia/v0.6/NGSIM/data/2_simple.txt"
